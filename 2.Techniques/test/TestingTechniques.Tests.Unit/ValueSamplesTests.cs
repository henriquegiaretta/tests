...
public class ValueSamplesTests
{
    ...
    public void StringAssertionExample()
    {
        ...
        fullName.Should().Be("Henrique Giaretta");
        fullName.Should().NotBeEmpty();
        fullName.Should().StartWith("Henri");
        fullName.Should().EndWith("Giaretta");
    }
    ...
    public void EnumerableObjectsAssertionExample()
    {
        ...
        users.Should().Contain(x => x.FullName.StartsWith("Henri") && x.Age > 5);
    }
